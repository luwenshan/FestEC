...
import com.lws.latte.R;
import com.lws.latte.util.dimen.DimenUtil;
...
public class LatteLoader {
    ...
    private static final String DEFAULT_STYLE = LoaderStyle.BallClipRotatePulseIndicator.name();
